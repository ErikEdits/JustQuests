                    ...
                    for (Map.Entry<String, JsonElement> e : root.getAsJsonObject().entrySet()) {
                        ...
                        try {
                            ResourceLocation id = key.contains(":")
                                ...
                                : ResourceLocation.fromNamespaceAndPath("justquests", key);

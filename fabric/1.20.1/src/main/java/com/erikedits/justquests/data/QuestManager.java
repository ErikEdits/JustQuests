...
public class QuestManager extends SimpleJsonResourceReloadListener implements IdentifiableResourceReloadListener {
    @Override
    public net.minecraft.resources.ResourceLocation getFabricId() { return new net.minecraft.resources.ResourceLocation(com.erikedits.justquests.JustQuests.MOD_ID, "quests"); }

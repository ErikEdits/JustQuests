...
public record MessageReward(LocalizedText message) implements QuestReward {
    ...
    public void grant(ServerPlayer player) {
        player.sendMessage(new net.minecraft.network.chat.TextComponent(message.get(com.erikedits.justquests.data.LocalizedText.DEFAULT_LANG)), net.minecraft.Util.NIL_UUID);
    }
